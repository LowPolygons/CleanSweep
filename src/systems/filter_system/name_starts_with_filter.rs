...
pub struct NameStartsWithFilter {
    keep_name: FilterCategory,
    delete_name: FilterCategory,
    init: bool,
}

impl NameStartsWithFilter {
    pub fn new() -> Self {
        Self {
...
impl FilterForCategory for NameStartsWithFilter {
    fn init(
        &mut self,
        ...
        self.keep_name = match &to_keep_category {
            FilterCategory::NameStartsWith(_) => to_keep_category,
        ...
        self.delete_name = match &to_delete_category {
            FilterCategory::NameStartsWith(_) => to_delete_category,
            _ => Err(FilterCategoryError::InititialisationError(format!(
